<template>
	<div>
	   <div style="text-align: center;line-height: 50px;">1098条评论</div>
	   <div class="button1">
	   		<el-button type="primary" size="small"  @click="isPostDialog=true">发布评论</el-button>
	   		<el-button type="primary" size="small" @click="$router.go(-1)">返回</el-button>
	   </div>
	   <el-tabs v-model="activeName" @tab-click="handleClick">
	    <el-tab-pane label="点赞最多" name="first">
	    	<div class="table2">
	    		<el-table :data="tableData"  :show-header="false" style="width: 100%" :height="$bus.clientHeight - 200">
